...
@Feature("Cancel leave request after two level approval test")
public class CancelLeaveRequestAfterLevelTwoManagerApprovalTest extends BaseHonoLeaveTest {
	...
	public void initMethodTest(String browser, String siteURL, String userName, String approverPassword)
		...
		driver = this.getWebDriver(browser, WEB_DRIVER.CANCEL_AFTER_LEAVEL_TWO);
