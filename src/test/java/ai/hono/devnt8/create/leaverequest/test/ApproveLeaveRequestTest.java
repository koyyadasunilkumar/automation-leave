...
@Epic("Hono Leave")
@Feature("Approve leave request test")
public class ApproveLeaveRequestTest extends BaseHonoLeaveTest {
	...
	private static final Logger logger = Logger.getLogger(ApproveLeaveRequestTest.class.getName());
	...
	public void verifyApproveLeaveWithoutReason() throws Exception {
		...
		try {
			...
			Assert.fail("Exception occured while testing verifyApproveLeaveWithoutReason : " + e.getMessage());
	...
	public void VerifyLeaveRequestStatusAfterApprovedByLevelTwoManager() {
		...
		try {
			...
			Assert.fail("Exception occured while testing VerifyLeaveRequestStatusAfterApprovedByLevelTwoManager : "
					+ e.getMessage());
