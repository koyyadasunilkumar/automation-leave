...
import io.github.bonigarcia.wdm.WebDriverManager;
		...
		public class BaseHonoLeaveTest {
			...
			public enum WEB_DRIVER {
				...
				LEVEL_TWO_RECONSIDER,REJECT_LEVEL_TWO_MANAGER,CANCEL_AFTER_LEAVEL_TWO,MY_TEAM_LEAVE_REQUEST,CREATE_SICK_LEAVE_REQUEST,CREATE_UNPAID_LEAVE_REQUEST,
				COMPENSATORY_OFF_LEAVE_REQUEST
			}
