...
import io.qameta.allure.Epic;
	...
	import io.restassured.response.Response;
		...
		@Epic("Hono Leave")
		@Feature("Create Leave Type test")
		public class LeaveTypeTest extends BaseHonoLeaveTest {
			...
			private static final Logger logger = Logger.getLogger(LeaveTypeTest.class.getName());

			@BeforeClass
			@Parameters({ "browser","siteURL","employeeUserName","employeepPssword" })
			public void initMethodTest(String browser,String siteURL,String userName,String password) throws Exception {
				logger.info("Starting of initMethodTest method");

				driver = this.getWebDriver(browser, WEB_DRIVER.CREATE_LEAVE_TYPE);

				loginToHono(browser, siteURL, userName, password, this.driver);
			...
			@Test(priority = 5, description = "Verify the Add Leave Type functionality by attempting to submit the form without providing all the mandatory details..")
			@Description("Test Case #5, Verify the Add Leave Type functionality by attempting to submit the form without providing all the mandatory details..")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #5, Verify the Add Leave Type functionality by attempting to submit the form without providing all the mandatory details..")
			public void verifyAddLeaveTypeDetailsWithoutGivingAllValidDetails() {
				logger.info("Starting of verifyAddLeaveTypeDetailsWithoutGivingAllValidDetails method");
				...
				try {
					...
					Assert.assertEquals(leaveTypePage.getLeaveToastMessage(),
							expectedAssertionsProp.getProperty(PLEASE_FILL_ALL_REQUIRED_FIELDS_TEXT));

				} catch (Exception e) {
					Assert.fail(
							"Exception occured while testing verifyAddLeaveTypeDetailsWithoutGivingAllValidDetails : " + e.getMessage());
					logger.error("Error occured while verifyAddLeaveTypeDetailsWithoutGivingAllValidDetails " + e);
				}

				logger.info("Starting of verifyAddLeaveTypeDetailsWithoutGivingAllValidDetails method");
			}
			
			@Test(priority = 6, description = "Verify Add Leave type details by giving all valid details")
			@Description("Test Case #6, Verify Add Leave type details by giving all valid details")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #6, Verify Add Leave type details by giving all valid details")
			...
			@Test(priority = 7, description = "Verify Created Leave Type details by selecting Last page")
			@Description("Test Case #7, Verify Created Leave Type details by selecting Last page")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #7, Verify Created Leave Type details by selecting Last page")
			...
			@Test(priority = 8, description = "Verify the leave type details by selecting the search option and entering the short name")
			@Description("Test Case #8, Verify the leave type details by selecting the search option and entering the short name")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #8, Verify the leave type details by selecting the search option and entering the short name")
			...
			@Test(priority = 9, description = "Verify the leave type details by selecting the Edit option")
			@Description("Test Case #9, Verify the leave type details by selecting the Edit option")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #9, Verify the leave type details by selecting the Edit option")
			...
			@Test(priority = 10, description = "Verify the Edit leave type details by selecting the Update option")
			@Description("Test Case #10, Verify the Edit leave type details by selecting the Update option")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #10, Verify the Edit leave type details by selecting the Update option")
			...
			@Test(priority = 11, description = "Verify leave type details after updating the Leave Name")
			@Description("Test Case #11, Verify leave type details after updating the Leave Name")
			@Severity(SeverityLevel.CRITICAL)
			@Story("Test Case #11, Verify leave type details after updating the Leave Name")
